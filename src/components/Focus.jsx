const Focus = () => {
	...
	<div
		tabIndex={0}
		className="collapse bg-primary text-primary-content focus:bg-secondary focus:text-secondary-content w-1/2 ml-[460px] border-double border-4 border-pink-500"
	>
